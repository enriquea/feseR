...
# save results
write.table(results, file = "analysis/metrics_genearray_univariate_PCA_RFE-RF.txt", sep = "\t", row.names = FALSE)

# save comple model profile
save(bestModel, file = "profiles/univariate_PCA_rfe_rf.rda")

# plotting rfe object
png("figures/GSE5325_univariate_PCA_RFE-RandomForest.png", width = 800, height = 800)
