...
# save results
write.table(results, file = "analysis/metrics_genearray_RFE-RF.txt", sep = "\t", row.names = FALSE)

# save comple model profile
save(bestModel, file = "profiles/rfe_rf.rda")

# plotting rfe object
png("figures/GSE5325_RFE-RandomForest.png", width = 800, height = 800)
